      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Edit Plan</h3>
          	
          	<!-- BASIC FORM ELELEMNTS -->
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div >
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Edit Plan</h4>
					  ...
					  <div class="col-sm-10">
						<input type="submit" class="btn btn-success" name="update_plan" value="Update"/>
						</div>
                          </div>
                      </form>
                  </div>
