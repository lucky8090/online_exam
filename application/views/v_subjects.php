...
<html lang="en">
  <head>
    <title>Subjetcs | Online Test App</title>
                ...
                <!-- <div class="row mt">
                    <div class="col-md-12">
                        <div class="content-panel" style="padding-bottom: 43px;">
                            ...
                            <form action="<?= site_url('c_subjects/sel_course');?>" method="post">
          	  ...
          	  <div class="row mt">
                  <div class="col-md-12">
                    ...
                    <table id="tableData" class="table table-striped table-bordered search-table" cellspacing="0" width="100%">
                        <div style="float:left;margin-left: 13px;"><a href="<?= site_url('c_subjects/add_subject');?>"><i class="btn btn-success">Add Subjects&nbsp;&nbsp;<i class="fa fa-plus"></i></i></div>
                        <thead>
                            <tr>
                                <th>S.no</th>
                                <th>Name</th>
                        ...
                        <tbody id="">
                            ...
                            <tr id="<?php echo $row['sub_id'];?>">
                                <td><?php echo $i;?></td>
                                <td><?php echo $row['sub_name'];?></td>
                            
                                <td><?php echo $row['sub_date'];?></td>
                                <td>
                                    <a href="#" onClick="Delete(<?php echo $row['sub_id'];?>);" class="btn btn-danger btn-xs" title="Delete"><i class="fa fa-trash-o "></i></a>
                                    <a href="<?= site_url('c_subjects/edit_subject/'.$row['sub_id']);?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                </td>
                            </tr>
                            <?php $i++; }}  else { ?>
                                <tr>
 ...
 <script type="text/javascript">
      ...
      $.ajax({
             type: "post", 
             url: "<?php echo site_url('c_subjects/delete'); ?>",
             data: value, 
