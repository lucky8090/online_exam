            ...
            <div class="row mt">
                <div class="col-md-12">
                    <div class="content-panel" style="padding-bottom: 43px;">
                        <div class="col-md-12">
                            <h4>Add Student Details</h4><hr/>
                        </div>
                        <form action="<?= site_url('c_students/add_student');?>" method="post">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" value="" class="form-control" name="name" id="name" required autofocus />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
