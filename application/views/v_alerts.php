  ...
  <?php include_once 'header.php';?>    
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
        ...
        <div style="float:left;"><a href="<?php echo base_url();?>c_alerts/add_alert"><i class="btn btn-success">Add Alerts</i></div>
                        <thead>
            <tr>
                <th>S.no</th>
                <th>Alert</th>
       ...
       <tbody id="">
                    ...
                    <button onClick="Delete(<?php echo $row->msg_id;?>);" class="btn btn-danger btn-xs" title="Delete"><i class="fa fa-trash-o "></i></button>
                    <form action="<?php echo site_url('c_alerts/edit_alert/'.$row->msg_id);?>" method="post">
...
//    var p_id = $('#del').val();
   // alert(p_id);
      ...
      $.ajax({
             ...
             url: "<?php echo site_url('c_alerts/delete'); ?>", // this will be the url of the jsp page where the values will be submitted
             data: value, //values
